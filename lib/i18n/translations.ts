export const translations = {
  en: {
    ...
    home: {
      ...
      heroDescriptionAuth:
        "Hello, {nickname}! Explore activities and share your artwork with the community.",
    ...
    activities: {
      ...
      unlimited: "Unlimited",
      checkBackLater: "Check back later for new art collection activities",
      longTerm: "Long-term",
      longTermActivity: "Long-term Activity",
      timeRemaining: "Time Remaining",
      uploadLimit: "Upload Limit",
      uploadsPerUser: "uploads per user",
      expired: "Expired",
      days: "days",
      hours: "hours",
      minutes: "minutes",
    ...
    admin: {
      ...
      deleteConfirm:
        'Are you sure you want to delete "{name}"? This action cannot be undone and will affect all associated artworks.',
      ...
      user: "User",
      admin: "Admin",
      activityArtworks: "Activity Artworks",
      activityArtworksDesc: "View all artworks submitted to this activity",
      totalArtworks: "total artworks",
      noArtworksInActivity: "No artworks found in this activity",
      artwork: "Artwork",
      author: "Author",
  ...
  zh: {
    ...
    activities: {
      ...
      noDeadline: "无截止时间",
      unlimited: "无限制",
      checkBackLater: "请稍后查看新的美术收藏活动",
      longTerm: "长期",
      longTermActivity: "长期活动",
      timeRemaining: "剩余时间",
      uploadLimit: "上传限制",
      uploadsPerUser: "次上传每用户",
      expired: "已过期",
      days: "天",
      hours: "小时",
      minutes: "分钟",
    ...
    admin: {
      ...
      deleteConfirm:
        '您确定要删除"{name}"吗？此操作无法撤销，将影响所有相关作品。',
      ...
      user: "用户",
      admin: "管理员",
      activityArtworks: "活动作品",
      activityArtworksDesc: "查看提交到此活动的所有作品",
      totalArtworks: "总作品数",
      noArtworksInActivity: "此活动中未找到作品",
      artwork: "作品",
      author: "作者",
      previewArtwork: "预览作品",
